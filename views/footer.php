...
<footer class="<?=$bgClass?> text-center <?=$txtClass?>">
  ...
  <div class="container p-4">
        ...
        <div class="row d-flex my-3 justify-content-center">
          ...
          <div class="col-md-5 col-12">
            ...
            <div class="form-outline form-white mb-4">
              ...
              <label class="form-label" for="form5Example21">Votre adresse mail</label>
            </div>
          </div>
          <!--Grid column-->
    ...
    <section class="mb-4">
    <p>
        L'équipe 22 est un site spécialisé dans les news 46k% SPORT ! A fond les ballons, roulez jeunesse !
    </p>
    <p>
        bottom text
    </p>
